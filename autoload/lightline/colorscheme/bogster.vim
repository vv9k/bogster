...
if exists('g:lightline')
    ...
    let s:p.normal.left = [ [ s:base0, s:lblue, 'bold' ], [ s:base5, s:base2, 'bold' ] ]
    let s:p.normal.right = [ [ s:base0, s:lblue ], [ s:base5, s:base2 ] ]
    ...
    let s:p.visual.left = [ [ s:base0, s:yellow, 'bold' ], [ s:base5, s:base2, 'bold' ] ]
    let s:p.visual.right = [ [ s:base0, s:yellow ], [ s:base5, s:base2 ] ]
